                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextButton.icon(
                          ...
                          onPressed: () {
                            // Inside build(), replace the Google Sign-in button with this:
                            Consumer<GoogleAuthViewModel>(
                              builder: (context, googleAuthViewModel, child) {
                                return googleAuthViewModel.isLoading
                                  ...
                                  child: TextButton.icon(
                                    ...
                                    onPressed: () async {
                                      ...
                                      bool success = await googleAuthViewModel.signInWithGoogle();
                                      ...
                                      if (success) {
                                        ...
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(
                                            content: Text(googleAuthViewModel.error ?? "Google sign-in failed"),
                                            backgroundColor: Theme.of(context).colorScheme.error,
                                          ),
                                        );
                                      }
